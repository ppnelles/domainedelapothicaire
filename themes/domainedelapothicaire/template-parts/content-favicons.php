...
<link rel="mask-icon" href="<?php bloginfo('template_directory'); ?>/img/favicons/safari-pinned-tab.svg" color="#ff000b">
<meta name="msapplication-TileColor" content="#ff000b">
